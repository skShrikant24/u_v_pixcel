...
class UimageClock extends StatefulWidget {
  const UimageClock({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<UimageClock> createState() => _UimageClockState();
}

class _UimageClockState extends State<UimageClock> {
  ...
  Future<void> _captureAndDownloadScreenshot() async {
    try {
      ...
      if (imageBytes != null) {
        ...
        //FFAppState().base64img = downloadURL;
...
class CircleShapeClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    double width = size.width;
    double height = size.height;
    path.moveTo(width * 0.4999954, height * 0.0012410);
    path.cubicTo(width * 0.6994928, height * 0.0012410, width * 0.9987670,
        height * 0.1408992, width * 0.9987670, height * 0.5000489);
    path.cubicTo(width * 0.9987670, height * 0.6995607, width * 0.8491440,
        height * 0.9988284, width * 0.4999954, height * 0.9988284);
    path.cubicTo(width * 0.3004979, height * 0.9988284, width * 0.0012237,
        height * 0.8491803, width * 0.0012237, height * 0.5000489);
    path.cubicTo(width * 0.0012237, height * 0.3005086, width * 0.1508468,
        height * 0.0012410, width * 0.4999954, height * 0.0012410);
