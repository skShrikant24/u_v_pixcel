...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF002555);
  late Color secondary = const Color(0xFFFB3D47);
  late Color tertiary = const Color(0xFF0228FF);
  late Color alternate = const Color(0xFF64A3FF);
  late Color primaryText = const Color(0xFF00122B);
  late Color secondaryText = const Color(0xFF586D91);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFFFFF);
  late Color accent2 = const Color(0xFF00122B);
  late Color accent3 = const Color(0xFF86BCE4);
  late Color accent4 = const Color(0xFFFFE5E5);
  late Color success = const Color(0xFF4EBB37);
