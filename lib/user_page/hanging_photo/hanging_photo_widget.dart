...
import 'hanging_photo_model.dart';
export 'hanging_photo_model.dart';
import 'dart:convert';

import 'package:firebase_storage/firebase_storage.dart';
import 'package:screenshot/screenshot.dart';
class HangingPhotoWidget extends StatefulWidget {
  const HangingPhotoWidget({super.key});

  @override
  State<HangingPhotoWidget> createState() => _HangingPhotoWidgetState();
}

class _HangingPhotoWidgetState extends State<HangingPhotoWidget> {
  late HangingPhotoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HangingPhotoModel());
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(8.0),
                                                        child: Image.network(
                                                          'https://firebasestorage.googleapis.com/v0/b/uvpixcel.appspot.com/o/7%20(2)%20(1).jpg?alt=media&token=0a7cbcda-2346-4eb7-8241-d3de5b8ddcde',
                                                          width: 500.0,
                                                          height: 500.0,
                                                          fit: BoxFit.cover,
                                                        ),
                        ...
                        children: [
                          ...
                          const Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                15.0, 0.0, 15.0, 5.0),
                            child: FlutterFlowVideoPlayer(
                              path: 'assets/videos/Picture-Quick-Mounting.mp4',
                              videoType: VideoType.asset,
                              autoPlay: true,
                              looping: true,
                              showControls: false,
