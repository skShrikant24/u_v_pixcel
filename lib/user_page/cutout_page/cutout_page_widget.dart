...
import 'cutout_page_model.dart';
export 'cutout_page_model.dart';
import 'dart:convert';

import 'package:firebase_storage/firebase_storage.dart';
import 'package:screenshot/screenshot.dart';
class CutoutPageWidget extends StatefulWidget {
  const CutoutPageWidget({
    super.key,
    this.categorydoc,
    String? prdTitle,
    this.category,
  ...
  @override
  State<CutoutPageWidget> createState() => _CutoutPageWidgetState();
}

class _CutoutPageWidgetState extends State<CutoutPageWidget> {
  late CutoutPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CutoutPageModel());
                    ...
                    children: [
                                    ...
                                    Container(
                                      constraints: BoxConstraints(
                                        minWidth: valueOrDefault<double>(
                                          _model.uploadedLocalFile1.width,
                                          500.0,
                                        ),
                      ...
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 10.0),
                        child: Text(
                          'Your Image will be cutout manually',
                          style: FlutterFlowTheme.of(context)
                              .bodyLarge
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
