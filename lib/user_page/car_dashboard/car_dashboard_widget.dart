...
import 'car_dashboard_model.dart';
export 'car_dashboard_model.dart';

class CarDashboardWidget extends StatefulWidget {
  const CarDashboardWidget({super.key});

  @override
  State<CarDashboardWidget> createState() => _CarDashboardWidgetState();
}

class _CarDashboardWidgetState extends State<CarDashboardWidget> {
  late CarDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarDashboardModel());
                                                    ...
                                                    child: Screenshot(
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        child: custom_widgets
                                                          ...
                                                          heightMedia: 400.0,
                                                          frameImage:
                                                          'https://firebasestorage.googleapis.com/v0/b/uvpixcel.appspot.com/o/car.png?alt=media&token=e23756ba-951c-445d-80cc-1d4acb25b742',
                                                        ),
                                                      ),),
                                                  ),
                              ...
                              FFButtonWidget(
                                ...
                                options: FFButtonOptions(
                                  ...
                                  iconPadding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 0.0),
                                  color: FFAppState().carDashboardSide ==
                                      'One Side'
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            if (_model.uploadedLocalFile1 != null &&
                              ...
                              setState(() {
                                FFAppState().count =
                                    FFAppState().count + FFAppState().orderList.length;
                              });
                              await _captureAndDownloadScreenshot();
                              setState(() {
                                FFAppState().orders = OrdersStruct(
                                  imageurl: valueOrDefault<String>(
                                    functions.imgstringToimgPath(FFAppState().editedimg),
                                    'n',
                                  ),
                                  price: FFAppState().productPrice,
                                  qty: 1.0,
                                  originalimage: _model.uploadedFileUrl2,
                                  categoryName: 'Acrylic Car Dashboard Photo With Stand',
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Error'),
                                    content: Text('Plaese Select Image First'),
                                    actions: [
                                      TextButton(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 10.0, 0.0, 10.0),
                                child: Text(
                                  ' UVPIXEL TM : ACRYLIC CAR DASHBOARD PHOTO WITH STAND',
                                  style: FlutterFlowTheme.of(context)
                                      .headlineMedium
                                      .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content: const Text('Plaese Select Image First'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
