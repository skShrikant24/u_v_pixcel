...
import 'clockpageedit_model.dart';
export 'clockpageedit_model.dart';
import 'dart:convert';
import 'package:firebase_storage/firebase_storage.dart';
import 'package:screenshot/screenshot.dart';
class ClockpageeditWidget extends StatefulWidget {
  const ClockpageeditWidget({
    super.key,
    this.productTitle,
    this.categoryId,
    this.category,
  ...
  @override
  State<ClockpageeditWidget> createState() => _ClockpageeditWidgetState();
}

class _ClockpageeditWidgetState extends State<ClockpageeditWidget> {
  late ClockpageeditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClockpageeditModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        ...
        widget.category?.title == 'Acrylic Frame With High Gloss'
            ? true
            : false;
