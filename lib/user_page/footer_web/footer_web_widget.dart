...
class _FooterWebWidgetState extends State<FooterWebWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(100.0, 40.0, 100.0, 50.0),
        child: Row(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Email : sumangraphics111@gmail.com',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            await launchURL('https://wa.me/+919689729777');
                          },
                          child: FaIcon(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('RefundAndReturnPolicy');
                        },
                        child: Text(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Address: Office no. 40, DSK Chintamani Complex, Shaniwar Peth,Pune-411030',
                      style: FlutterFlowTheme.of(context).titleSmall.override(
                            fontFamily:
                                FlutterFlowTheme.of(context).titleSmallFamily,
                            color: FlutterFlowTheme.of(context).accent1,
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Address: Swami sparsh, \'A\' building, opp. Manohar garden, near Jadhav nagar, Raikar mala, Dhayri, Pune 411041.',
                      style: FlutterFlowTheme.of(context).titleSmall.override(
                            fontFamily:
                                FlutterFlowTheme.of(context).titleSmallFamily,
                            color: FlutterFlowTheme.of(context).accent1,
