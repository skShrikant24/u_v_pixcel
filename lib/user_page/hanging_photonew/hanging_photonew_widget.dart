...
import 'hanging_photonew_model.dart';
export 'hanging_photonew_model.dart';

class HangingPhotonewWidget extends StatefulWidget {
  const HangingPhotonewWidget({super.key});

  @override
  State<HangingPhotonewWidget> createState() => _HangingPhotonewWidgetState();
}

class _HangingPhotonewWidgetState extends State<HangingPhotonewWidget> {
  late HangingPhotonewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HangingPhotonewModel());
