...
import 'collage_page2img_model.dart';
export 'collage_page2img_model.dart';

class CollagePage2imgWidget extends StatefulWidget {
  const CollagePage2imgWidget({
    super.key,
    this.categorydoc,
    String? prdTitle,
  ...
  @override
  State<CollagePage2imgWidget> createState() => _CollagePage2imgWidgetState();
}

class _CollagePage2imgWidgetState extends State<CollagePage2imgWidget> {
  late CollagePage2imgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CollagePage2imgModel());
