...
import 'collage_page9img_model.dart';
export 'collage_page9img_model.dart';
import 'dart:convert';

import 'package:firebase_storage/firebase_storage.dart';
import 'package:screenshot/screenshot.dart';
class CollagePage9imgWidget extends StatefulWidget {
  const CollagePage9imgWidget({
    super.key,
    this.categorydoc,
    String? prdTitle,
  ...
  @override
  State<CollagePage9imgWidget> createState() => _CollagePage9imgWidgetState();
}

class _CollagePage9imgWidgetState extends State<CollagePage9imgWidget> {
  late CollagePage9imgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CollagePage9imgModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        ...
        'https://firebasestorage.googleapis.com/v0/b/uvpixcel.appspot.com/o/Upload%20img%203.png?alt=media&token=af3a3bd7-fca3-4c08-9598-b75d34a2db8d';
        FFAppState().collageImgUrl7 =
        'https://firebasestorage.googleapis.com/v0/b/uvpixcel.appspot.com/o/Upload%20img%203.png?alt=media&token=af3a3bd7-fca3-4c08-9598-b75d34a2db8d';
        FFAppState().collageImageUrl8 =
        'https://firebasestorage.googleapis.com/v0/b/uvpixcel.appspot.com/o/Upload%20img%203.png?alt=media&token=af3a3bd7-fca3-4c08-9598-b75d34a2db8d';
        FFAppState().collageImageUrl9 =
        'https://firebasestorage.googleapis.com/v0/b/uvpixcel.appspot.com/o/Upload%20img%203.png?alt=media&token=af3a3bd7-fca3-4c08-9598-b75d34a2db8d';
      });
    });
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: custom_widgets
                                                                          ...
                                                                          'Square',
                                                                          imageUrl:
                                                                          functions.imageurlToString(FFAppState().collageImgUrl7),
                                                                          zoomPercent:
                                                                          2.0,
                                                                          size:
                                                                          '12X9',
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: custom_widgets
                                                                          ...
                                                                          'Square',
                                                                          imageUrl:
                                                                          functions.imageurlToString(FFAppState().collageImageUrl8),
                                                                          zoomPercent:
                                                                          2.0,
                                                                          size:
                                                                          '12X9',
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: custom_widgets
                                                                          ...
                                                                          'Square',
                                                                          imageUrl:
                                                                          functions.imageurlToString(FFAppState().collageImageUrl9),
                                                                          zoomPercent:
                                                                          2.0,
                                                                          size:
                                                                          '12X9',
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            if ((FFAppState().size != '') &&
                              ...
                              setState(() {
                                FFAppState()
                                    .addToCollagelist(_model.uploadedFileUrl13);
                              });
                              setState(() {
                                FFAppState()
                                    .addToCollagelist(_model.uploadedFileUrl14);
                              });
                              setState(() {
                                FFAppState()
                                    .addToCollagelist(_model.uploadedFileUrl15);
                              });
                              setState(() {
                                FFAppState()
                                    .addToCollagelist(_model.uploadedFileUrl16);
                              });
                              setState(() {
                                FFAppState()
                                    .addToCollagelist(_model.uploadedFileUrl17);
                              });
                              setState(() {
                                FFAppState()
                                    .addToCollagelist(_model.uploadedFileUrl18);
                              });
                              await _captureAndDownloadScreenshot();
                              setState(() {
                                FFAppState().updateOrdersStruct(
