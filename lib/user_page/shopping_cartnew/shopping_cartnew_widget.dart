...
import 'shopping_cartnew_model.dart';
export 'shopping_cartnew_model.dart';

class ShoppingCartnewWidget extends StatefulWidget {
  const ShoppingCartnewWidget({super.key});

  @override
  State<ShoppingCartnewWidget> createState() => _ShoppingCartnewWidgetState();
}

class _ShoppingCartnewWidgetState extends State<ShoppingCartnewWidget> {
  late ShoppingCartnewModel _model;
                                                                  ...
                                                                  Expanded(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            '${orderListItem.categoryName}${valueOrDefault<String>(
                                                                              orderListItem.size,
                                                                              '0',
                                                                            )},${orderListItem.thickness}',
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('CheckoutDetails');
                                      },
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  '${orderListItem.categoryName},${orderListItem.categoryName}${valueOrDefault<String>(
                                                                    orderListItem
                                                                        .size,
                                                                    '0',
                                                                  )},${orderListItem.thickness}',
