...
import 'collage_page_new_model.dart';
export 'collage_page_new_model.dart';
import 'dart:convert';

import 'package:firebase_storage/firebase_storage.dart';
import 'package:screenshot/screenshot.dart';
class CollagePageNewWidget extends StatefulWidget {
  const CollagePageNewWidget({
    super.key,
    this.categorydoc,
    String? prdTitle,
  ...
  @override
  State<CollagePageNewWidget> createState() => _CollagePageNewWidgetState();
}

class _CollagePageNewWidgetState extends State<CollagePageNewWidget> {
  late CollagePageNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CollagePageNewModel());
