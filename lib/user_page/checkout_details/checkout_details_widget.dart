                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    if (FFAppState().orderList.isNotEmpty) {
                                      if ((_model.textController1.text != '') &&
                                        ...
                                        _model.orderid =
                                          ...
                                          queryBuilder: (ordersRecord) =>
                                              ordersRecord.orderBy('orderId',
                                                  descending: true),
                                          singleRecord: true,
                                        ).then((s) => s.firstOrNull);
                                        if ((_model.orderid != null) == true) {
                                          setState(() {
                                            FFAppState().orderId =
                                                valueOrDefault<int>(
                                        ...
                                        await ordersRecordReference.set({
                                          ...createOrdersRecordData(
                                            finalAmt: functions.totalCalculate(
                                                FFAppState().FinalAmt, 0.0),
                                            deliveryCharges: 0.0,
                                            subTotal: FFAppState().FinalAmt,
                                            userdetails:
                                                updateUserOrderdetailsStruct(
                                        ...
                                        await _model.docOrderw!.reference
                                            .update(createOrdersRecordData(
                                          id: _model.docOrderw?.reference.id,
                                        ));
                                      } else {
                                        await showDialog(
                                          context: context,
                                      ...
                                      _model.apiResultnbp =
                                        ...
                                        merchantTransactionId:
                                            FFAppState().merchantTransactionId,
                                        merchantUserId:
                                            'MUI${getCurrentTimestamp.millisecondsSinceEpoch.toString()}',
                                        amount: valueOrDefault<double>(
                                          functions
                                              .finalAmt(FFAppState().FinalAmt),
                                          0.0,
                                        ),
                                        redirectUrl:
                                      ...
                                      if ((_model.apiResultnbp?.succeeded ??
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text((_model.apiResultnbp
                                                          ?.jsonBody ??
                                                      '')
                                                  .toString()),
                                              actions: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          if (FFAppState().orderList.isNotEmpty) {
                            if ((_model.textController9.text != '') &&
                              ...
                              await ordersRecordReference.set({
                                ...createOrdersRecordData(
                                  ...
                                  deliveryCharges: 0.0,
                                  subTotal: FFAppState().FinalAmt,
                                  userdetails: updateUserOrderdetailsStruct(
                                    FFAppState().userOrderDetails,
                                    clearUnsetFields: false,
                                    create: true,
                                  ),
                                  orderId: _model.orderid?.orderId,
                                  status: 'Pending',
                                  orderAt: getCurrentTimestamp
                                      .millisecondsSinceEpoch,
                                  transactionId:
                                ...
                                ...mapToFirestore(
                                  {
                                    'orderList': getOrdersListFirestoreData(
                                      FFAppState().orderList,
                                    ),
                                  },
                                ),
                              ...
                              await _model.docOrder!.reference
                                  .update(createOrdersRecordData(
                                id: _model.docOrderw?.reference.id,
                              ));
                            } else {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    content: const Text('Pls fill all Details !'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                            ...
                            _model.apiResultnbp2 = await PayAPICall.call(
                              merchantId: 'PGTESTPAYUAT',
                              merchantTransactionId:
                                  FFAppState().merchantTransactionId,
                              merchantUserId:
                                  'MUI${getCurrentTimestamp.millisecondsSinceEpoch.toString()}',
                              amount: valueOrDefault<double>(
                                functions.finalAmt(FFAppState().FinalAmt),
                                0.0,
                              ),
                              redirectUrl: 'https://uvpixel.com/orderStatus',
                              redirectMode: 'POST',
                              callbackUrl: 'https://uvpixel.com/orderStatus',
                              mobileNumber:
                                  functions.stringToInt(valueOrDefault<String>(
                                FFAppState().userOrderDetails.mobileNo,
                                '0',
                              )),
                              type: 'PAY_PAGE',
                            );
