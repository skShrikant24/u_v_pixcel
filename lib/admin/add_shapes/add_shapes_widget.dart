...
import 'add_shapes_model.dart';
export 'add_shapes_model.dart';

class AddShapesWidget extends StatefulWidget {
  const AddShapesWidget({
    super.key,
    this.codeLen,
  });
  ...
  @override
  State<AddShapesWidget> createState() => _AddShapesWidgetState();
}

class _AddShapesWidgetState extends State<AddShapesWidget> {
  late AddShapesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddShapesModel());
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            var shapesRecordReference =
                                ShapesRecord.collection.doc();
                            await shapesRecordReference
                                .set(createShapesRecordData(
                              icon: _model.priceTextFeildTextController.text,
                              code: widget.codeLen,
                              name: _model.mrpTextFeildTextController.text,
                            ));
                            _model.docRef = ShapesRecord.getDocumentFromData(
                                createShapesRecordData(
                                  icon:
                                      _model.priceTextFeildTextController.text,
                                  code: widget.codeLen,
                                  name: _model.mrpTextFeildTextController.text,
                                ),
                                shapesRecordReference);

                            await _model.docRef!.reference
                                .update(createShapesRecordData(
                              id: _model.docRef?.reference.id,
                            ));
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content:
                                      const Text('Shape Record  Add Successfully '),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
