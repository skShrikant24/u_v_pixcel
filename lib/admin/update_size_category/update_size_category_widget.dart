...
import 'update_size_category_model.dart';
export 'update_size_category_model.dart';

class UpdateSizeCategoryWidget extends StatefulWidget {
  const UpdateSizeCategoryWidget({
    super.key,
  ...
  final SizeMapStruct? sizeMap;

  @override
  State<UpdateSizeCategoryWidget> createState() =>
      _UpdateSizeCategoryWidgetState();
}

class _UpdateSizeCategoryWidgetState extends State<UpdateSizeCategoryWidget> {
  late UpdateSizeCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateSizeCategoryModel());
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController ??=
                                ...
                                _model.dropDownValue ??= widget.sizeId,
                              ),
                              options: List<String>.from(dropDownSizeRecordList
                                  .map((e) => e.id)
                                  .toList()),
                                                            ...
                                                            children: [
                                                              StreamBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  final textThicknessRecord = textThicknessRecordList
                                                                          .isNotEmpty
                                                                      ? textThicknessRecordList
                                                                          .first
                                                                      : null;
