...
import 'add_thickness_model.dart';
export 'add_thickness_model.dart';

class AddThicknessWidget extends StatefulWidget {
  const AddThicknessWidget({
    super.key,
    this.codeLen,
  });
  ...
  @override
  State<AddThicknessWidget> createState() => _AddThicknessWidgetState();
}

class _AddThicknessWidgetState extends State<AddThicknessWidget> {
  late AddThicknessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddThicknessModel());
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            var thicknessRecordReference =
                                ThicknessRecord.collection.doc();
                            await thicknessRecordReference
                                .set(createThicknessRecordData(
                            ...
                            _model.thicknessDocRef =
                                ThicknessRecord.getDocumentFromData(
                                    createThicknessRecordData(
                                      value: double.tryParse(_model
                                          .priceTextFeildTextController.text),
                                      name: _model
                                          .mrpTextFeildTextController.text,
                                      code: int.tryParse(_model
                                          .textCatalogueCodeTextController
                                          .text),
                                    ),
                                    thicknessRecordReference);

                            await _model.thicknessDocRef!.reference
                                .update(createThicknessRecordData(
                              id: _model.thicknessDocRef?.reference.id,
                            ));
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: const Text(
                                      'Thickness Record  Add Successfully '),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
