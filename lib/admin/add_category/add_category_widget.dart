...
class _AddCategoryWidgetState extends State<AddCategoryWidget> {
  ...
  void initState() {
    ...
    _model.mrpTextFeildTextController1 ??= TextEditingController();
    _model.mrpTextFeildFocusNode1 ??= FocusNode();

    _model.priceTextFeildTextController3 ??= TextEditingController();
    _model.priceTextFeildFocusNode3 ??= FocusNode();

    _model.mrpTextFeildTextController2 ??= TextEditingController();
    _model.mrpTextFeildFocusNode2 ??= FocusNode();

    _model.priceTextFeildTextController4 ??= TextEditingController();
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            valueOrDefault<String>(
                              FFAppState().img,
                              'https://firebasestorage.googleapis.com/v0/b/uvpixcel.appspot.com/o/users%2FrdUdSGneloMcA1zXCUq20UWqb0C2%2Fuploads%2F1709546292411000.jpeg?alt=media&token=1b3edef3-c985-44c3-a238-94268ceb142b',
                            ),
                            width: 225.0,
                            height: 175.0,
                            fit: BoxFit.cover,
                              ...
                              child: Builder(
                                builder: (context) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount: sizeLis.length,
                                    itemBuilder: (context, sizeLisIndex) {
                                      final sizeLisItem = sizeLis[sizeLisIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 10.0, 0.0),
                                        child: Container(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              await categoryRecordReference.set({
                              ...
                              await _model.categoryDocRef!.reference
                                ...
                                categoryId: _model.categoryDocRef?.reference.id,
                              ));
                              setState(() {
                                FFAppState().img =
