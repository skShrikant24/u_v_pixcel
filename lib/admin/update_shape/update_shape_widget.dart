...
import 'update_shape_model.dart';
export 'update_shape_model.dart';

class UpdateShapeWidget extends StatefulWidget {
  const UpdateShapeWidget({
    super.key,
    this.shapeDocRef,
  });

  final DocumentReference? shapeDocRef;

  @override
  State<UpdateShapeWidget> createState() => _UpdateShapeWidgetState();
}

class _UpdateShapeWidgetState extends State<UpdateShapeWidget> {
  late UpdateShapeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateShapeModel());
    ...
    return Column(
      ...
      children: [
        Form(
          ...
          child: StreamBuilder<ShapesRecord>(
            stream: ShapesRecord.getDocument(widget.shapeDocRef!),
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller: _model.mrpTextFeildTextController ??=
                          ...
                          text: containerShapesRecord.name,
                        ),
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  isDense: true,
                                  labelText: functions.imageurlToString(
                                      containerShapesRecord.icon),
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .titleLarge
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                              ...
                              child: TextFormField(
                                controller:
                                    _model.textCatalogueCodeTextController ??=
                                        TextEditingController(
                                  text: containerShapesRecord.code.toString(),
                                ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                await containerShapesRecord.reference
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: const Text(
                                          'Shape Record  Update Successfully '),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
